...
exports.createModel = function(type) {
  ...
  Model.prototype = {
    ...
    relation: function(name) {
      ...
      relationMethods.findAll = relationMethods.all;
      relationMethods.find = relationMethods.findOne = relationMethods.get;
      relationMethods.destroy = relationMethods.remove;
